...
void calcular_frequencia(char frase[], int frequencia[letras]) {
    for (int i = 0; i < letras; i++) {
        frequencia[i] = 0; // Inicializar todas as frequências como zero
    }
    ...
    // Agora vamos imprimir a frequência de cada letra
    for (int i = 0; i < letras; i++) {
