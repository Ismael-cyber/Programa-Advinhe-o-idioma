...
int detectar_idioma(char frase[]) {
    ...
    printf("======Frequencia de cada letra=======\n");
    ...
    for (int i = 0; i < letras; i++) {
        dif_ptg = fabs(freqptg[i] - frequencia[i]);
        dif_ing = fabs(freqing[i] - frequencia[i]);
    ...
    printf("=======Mostrar o resultado da diferenca de cada idioma=======\n");
    printf("Resultado da diferenca em Portugues: %f\n", dif_ptg);
    printf("Resultado da diferenca em Ingles: %f\n", dif_ing);
    printf("=======Mostrar o total de pontuacoes de cada idioma=======\n");
    printf("Pontuacao portugues: %d\n", pontuacao_ptg);
    printf("Pontuacao ingles: %d", pontuacao_ing);
